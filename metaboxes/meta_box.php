		...
		foreach ( $this->fields as $field) {
			...
			echo '<tr>
					...
					switch( $type ) {
						...
						case 'tax_select':
							echo '<select name="' . $id . '" id="' . $id . '">
									<option value="">اختيار</option>'; // Select One
							...
							echo '</select> &nbsp;<span class="description"><a href="' . home_url() . '/wp-admin/edit-tags.php?taxonomy=' . $id . '&post_type=' . $post_type . '">ادارة ' . $taxonomy->label . '</a></span>
								<br />' . $desc;
						break;
						// post_list
						case 'post_list':
							echo '<select name="' . $id . '" id="' . $id . '">
									<option value="">اخيار</option>'; // Select One
