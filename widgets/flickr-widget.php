...
class Flickr_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'flickr', 'description' => 'اضافة صور أكتب.كوم من موقع فليكر.');

		$control_ops = array('id_base' => 'flickr-widget');

		$this->WP_Widget('flickr-widget', 'أكتب.كوم : فليكر', $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => 'صور من فليكر', 'screen_name' => '', 'number' => 6);
		...
		<p>
			<label for="<?php echo $this->get_field_id('screen_name'); ?>">الرقم التعريفى لحساب أكتب.كوم</label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('number'); ?>">عدد الصور التى سوف تظهر:</label>
