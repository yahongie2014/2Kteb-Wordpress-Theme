...
class Socialicons_Widget extends WP_Widget {
	...
	{
		$widget_ops = array('classname' => 'socialicons', 'description' => 'اضافة المواقع الاجتماعية المرتبطة بموقع أكتب.كوم');

		$control_ops = array('id_base' => 'socialicons-widget');

		$this->WP_Widget('socialicons-widget', 'أكتب.كوم : المواقع الأجتماعية', $widget_ops, $control_ops);
	}
	...
	{
		$defaults = array('title' => 'المواقع الأجتماعية');
