...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('لوحة تحكم أكتب.كوم', 'egywebschool'), __('لوحة تحكم أكتب.كوم', 'egywebschool'), 'edit_theme_options', 'options-framework','optionsframework_page');
    ...
    <div id="optionsframework-metabox" class="metabox-holder">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'حفظ التغيرات', 'egywebschool' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'استعادة الضبط', 'egywebschool' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'قم بالظغط على موافق ليتم استعاددة ضبط المبرمج!', 'egywebschool' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
		</div> <!-- / #container -->
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'تم استعادة التغيرات.', 'egywebschool' ), 'updated fade' );
	 ...
	 */
		...
		add_settings_error( 'options-framework', 'save_options', __( 'تم حفظ التغيرات.', 'egywebschool' ), 'updated fade' );
		return $clean;
	}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'لوحة تحكم أكتب.كوم', 'egywebschool' ),
