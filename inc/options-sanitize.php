...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('عدم التكرار', 'egywebschool'),
		'repeat-x'  => __('تكرار أفقيا', 'egywebschool'),
		'repeat-y'  => __('تكرار رأسيا', 'egywebschool'),
		'repeat'    => __('تكرار الكل', 'egywebschool'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('اعلى اليسار', 'egywebschool'),
		'top center'    => __('اعلى المنتصف', 'egywebschool'),
		'top right'     => __('اعلى اليمين', 'egywebschool'),
		'center left'   => __('يسار الوسط', 'egywebschool'),
		'center center' => __('منتصف الوسط', 'egywebschool'),
		'center right'  => __('يمين الوسط', 'egywebschool'),
		'bottom left'   => __('يسار الأسفل', 'egywebschool'),
		'bottom center' => __('منتصف الاسفل', 'egywebschool'),
		'bottom right'  => __('يمين الأسفل', 'egywebschool')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('التمرير الطبيعى', 'egywebschool'),
		'fixed'  => __('الثبات', 'egywebschool')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'egywebschool'),
		'italic'      => __('Italic', 'egywebschool'),
		'bold'        => __('Bold', 'egywebschool'),
		'bold italic' => __('Bold Italic', 'egywebschool')
		);
